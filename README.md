...
- Resource URL: `/hacsfiles/bar-card-final/bar-card-final.js?v=20260324`
- Card type: `custom:bar-card`
- Bump the `v=` query string every time `bar-card-final.js` changes so browsers fetch the new bundle instead of a cached copy.
